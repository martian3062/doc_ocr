...
def api_dashboard(request):
    ...
    data = {
        ...
        "pipeline_stack": {
            ...
            "medical_handwriting_candidate_models": config.MEDICAL_HANDWRITING_CANDIDATE_MODEL_IDS,
            ...
            "schema_model": config.SCHEMA_LOCAL_MODEL_ID if config.SCHEMA_PROVIDER == "local" else config.SCHEMA_MODEL,
            "llm_provider": config.LLM_PROVIDER,
            "local_llm_enabled": config.ENABLE_LOCAL_HF_LLM,
            "local_llm_model": config.MODEL_ID,
