...
- **`Cmd+K` spotlight** — keyboard quick-navigation
...
└── evolet/                       # Django project root
    ...
    │       ├── pdf_extractor.py  # Native text + DocTR OCR + EasyOCR (thread-safe singletons)
    ...
    │
    └── static/
        ├── css/main.css          # Aurora mesh, Bulma dark-mode patches, animations
        └── js/app.js             # Alpine stores: toasts, spotlight, etaPanel, uploadHandler
```
